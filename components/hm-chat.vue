		...
		<view class="input-box" :class="popupLayerClass" @touchmove.stop.prevent="discard">
			...
			<view class="textbox">
				...
				<view class="text-mode"  :class="isVoice?'hidden':''">
					<view class="box">
						<textarea auto-height="true" v-model="textMsg" @focus="textareaFocus" maxlength="20"/>
					</view>
		...
		methods:{
			...
			loadHistory(e){
				...
				setTimeout(()=>{
					...
					let list = [
						...
						{type:"user",msg:{id:2,type:"text",time:"12:57",userinfo:{uid:1,username:"张老师008",face:"/static/img/im/face/face_2.jpg"},content:{text:"这个是有偏差的，两个温度相差十几二十度是很正常的，如果相差五十度，那即是质量问题了。"}}},
						{type:"user",msg:{id:3,type:"voice",time:"12:59",userinfo:{uid:1,username:"王主任008",face:"/static/img/im/face/face_2.jpg"},content:{url:"/static/voice/1.mp3",length:"00:06"}}},
			...
			sendMsg(content,type){
				...
				setTimeout(()=>{
					...
					lastid++;
					msg = {type:'user',msg:{id:lastid,time:nowDate.getHours()+":"+nowDate.getMinutes(),type:type,userinfo:{uid:1,username:"发财讲师008",face:"/static/img/im/face/face_2.jpg"},content:content}}
					// 本地模拟发送消息
					this.screenMsg(msg);
				},3000)
			},
				...
				setTimeout(()=>{
					...
					if(rid==0){
						...
						if(!msg.content.isReceived){
							// {type:"system",msg:{id:8,type:"redEnvelope",content:{text:"你领取了发财讲师008的红包"}}},
